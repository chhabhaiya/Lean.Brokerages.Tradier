        ...
        private static TestCaseData[] TestParameters
        {
            get
            {
                return new[]
                {
                    ...
                    new TestCaseData(Symbol.Create("XSP", SecurityType.Index, Market.USA), "XSP"),
                    ...
                    new TestCaseData(Symbol.CreateOption(Symbol.Create("XSP", SecurityType.Index, Market.USA), "XSP", Market.USA, SecurityType.IndexOption.DefaultOptionStyle(), OptionRight.Call, 480m, new DateTime(2025, 7, 25)), "XSP250725C00480000"),
                };
            }
        }
